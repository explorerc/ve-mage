  ...
  <div class="live-mager play-back">
    <div class="live-title"
      ...
      <button class="primary-button fr"
              ...
              @click="addVideoClickShow">添加视频</button>
    </div>
          ...
          <div class="from-row">
            ...
            <div class="from-content">
              <el-radio v-model="playBackMode"
                        label="0">上传视频</el-radio>
              <el-radio v-model="playBackMode"
                        label="1">链接引用</el-radio>
              <div class="from-msg-tip">
                <ve-msg-tips tip='您可以直接引用视频网站上的资源，将播放地址复制到输入框。比如爱奇艺或腾讯视频“分享”中的“通用代码”，示例如下：<iframe frameborder="0" width="640" height="498" src="https://v.qq.com/iframe/player.html?vid=zxxx7hcc6iu&tiny=0&auto=0" allowfullscreen></iframe>'></ve-msg-tips>
              </div>
            </div>
          </div>
          <div class="from-row"
               v-if="playBackMode==0">
            <div class="from-title"><i class="star">*</<template>
                <div class="live-mager play-back">
                  <div class="live-title"
                       style="margin-top: 30px;">
                    <span class="title">活动回放</span>
                        ...
                        <div class="from-row">
                          ...
                          <div class="from-content">
                            <el-radio v-model="outLineMode"
                                      label="0">与活动同步下线</el-radio>
                            <el-radio v-model="outLineMode"
                                      label="1">指定下线时间</el-radio>
                          </div>
                        </div>
