  ...
  <div class='detail-wrap'
    ...
    <div class="desc clearfix">
      <div class="left">
        ...
        <span class="state"
              :class="stateClass">{{state}}</span>
      </div>
      <div class="middle">
        <p class='title'>{{title}} <span class='id-tag'>ID:{{activityId}} <i></i></span></p>
        <p class='desc-label'>互动标签: <span class="tag"
        ...
        <ol class='clearfix'>
          ...
          <li class='icon copy'
              @click='copy'><i></i>复制链接<input type="text" :value="`www.baidu.com/${this.activityId}`" id='copyContent' style='position:absolute;opacity:0;'></li>
          <li class='icon offline'
              @click='offlineActive'
              v-if="isPublished"><i></i>下线活动</li>
          <li class='icon offline'
              @click='publishActive'
              v-else><i></i>发布活动</li>
        </ol>
    ...
    <div class="fun-card">
          ...
          <div class='item apply'
            ...
            <div class="btm">
              <el-switch class='switch'
                         ...
                         :width="32"
                         active-color="#FFD021"
                         @change="switchChange('APPOINT', dataPrepare[1].switch)"></el-switch>
              <!-- <span class='set'>设置</span> -->
            </div>
          </div>
          <div class='item wram'
            ...
            <div class="btm">
              <el-switch class='switch'
                         ...
                         :width="32"
                         active-color="#FFD021"
                         @change="switchChange('WARMUP',dataPrepare[2].switch)"></el-switch>
              <!-- <span class='set'>设置</span> -->
            </div>
          </div>
        </div>
          ...
          <div class='item automaze'
            ...
            <div class="btm">
              <el-switch class='switch'
                         ...
                         :width="32"
                         active-color="#FFD021"
                         @change="switchChange('EXPAND_NOTICE', dataPromote[0].switch)"></el-switch>
              <!-- <span class='set'>设置</span> -->
            </div>
          </div>
      ...
      <div class="item promote">
        ...
        <div class="card-list clearfix">
          <div class='item site'
               @click="linkTo($event,'/liveMager/site/', dataBrand[2].switch)">
            <!-- 活动官网 -->
            <div class="card">
              <div class='pic'>
                <!-- <img :src="propImg"> -->
            ...
            <div class="btm">
              <el-switch class='switch'
                         v-model="dataBrand[2].switch"
                         inactive-color="#DEE1FF"
                         :width="32"
                         active-color="#FFD021"
                         @change="switchChange('TEMPLATE', dataBrand[2].switch)"></el-switch>
              <!-- <span class='set'>设置</span> -->
            </div>
          </div>
