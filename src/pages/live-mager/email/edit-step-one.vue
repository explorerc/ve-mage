  ...
  <div class="edit-step-box" @keydown="canPass = false">
    ...
    <div class="border-box">
      <div class="edit-content clearfix">
        ...
        <div class="edit-content-temp fr">
          ...
          <div class="temp-boxs">
            <div v-for="(emailItem,idx) in emailList" :class="{'temp-item':true,fl:true,active:emailItem.emailTemplateId==email.emailTemplateId}" @click.stop="changeTemp(idx)">
    ...
    <message-box v-show="testEmailShow" header="邮件测试发送" type="prompt" width="450px" @handleClick="emailHandleClick">
      <div class="email-box">
        ...
        <com-input :value.sync="testEmailAddress" :error-tips="emailError" :maxLength="40" @keyup.enter.native="sendTestEmail" placeholder="输入邮件地址" />
      </div>
    ...
    <div class="email-bottom">
      ...
      <button class="default-button margin-fl fr" @click="saveEmail">保存草稿
        </button>
    </div>
  </div>
</template>
