<template>
  <div class="content"
      ...
      <div class='mager-box border-box'>
        <div class="from-box">
          ...
          <div class="from-row">
            ...
            <div class="from-content">
              <template v-for="(item,idx) in selectedGroupList"> {{item.name}}({{item.count}}) </template>
              <template v-for="(item,idx) in selectedTagList"> {{item.name}} </template>
    ...
    <transition name='fade' mode='out-in' v-if="sendDetail">
      <com-detail _type="WECHAT"  @handleClick="handleClick"></com-detail>
    </transition>
  </div>
</template>
