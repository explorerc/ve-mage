<template>
  <div class="content"
    ...
    <div class="edit-wx-page live-mager">
        ...
        <div class="from-box ">
          ...
          <div class="from-row"
            ...
            <div class="from-content">
              ...
              <ve-tips tip="微信通知只能发送给关注该公众号或服务号的人群，已选收件人中没有关注微信的，将无法收到该通知。"
          ...
          <!-- 模拟手机预览 -->
          <com-phone :titleValue='titleValue'
                     :date='date'
                     :wxContent='wxContent'
      ...
      <!-- 测试发送弹窗 -->
      <com-test :imgUrl="qrImgurl"
                v-if='testModal'
                @closeTest='closeTest'
                :type="'Wechat'"></com-test>
    </div>
  </div>
</template>
