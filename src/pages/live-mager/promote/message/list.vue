      ...
      <div class="live-title">
        ...
        <div class="right-box">
          <button class="default-button fr">
            <router-link :to="{ name:'msgCreate',params:{id:queryData.activityId} }">新建微信</router-link>
          </button>
        </div>
      </div>
        ...
        <el-table :data="tableData"
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <div class="tool-box">
                <span>
                  <router-link :to="{ name:'msgOverview', query:{ id : scope.row.inviteId}}">查看</router-link>
                </span>
