...
<template>
  <div class='pond-page'>
    ...
    <transition name='fade' mode='out-in' v-if="showChooseActive">
      <com-choose @handleClick="handleClick" @selectComConfirm='selectActiveConfirm' :checkedData='activityArray'
                  :max='10' @searchHandler='searchHandler' :name="'活动'"></com-choose>
    </transition>
    <transition name='fade' mode='out-in' v-if="showChooseTag">
      <com-choose @handleClick="handleClick" @selectComConfirm='selectTagConfirm' :checkedData='tagArray' :max='10'
                  @searchHandler='searchHandler' :name="'标签'"></com-choose>
    </transition>
